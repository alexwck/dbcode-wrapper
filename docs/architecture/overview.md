...
8. **Patch Plan** applies the maintained Code OSS and VSCodium overlay by semantic seam. On a cold build, VSCodium runs the final tree check after all official and wrapper patches are applied and before Code OSS compilation starts.

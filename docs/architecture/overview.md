...
Active slimming and rollback controls remain machine-readable in `host/slimming-policy.json`. Dated size, file-count, and startup measurements live in [`host-slimming-measurement-2026-07-21.md`](host-slimming-measurement-2026-07-21.md), so historical observations cannot change a Compiled Host identity.

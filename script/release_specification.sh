...
usage() {
  echo "Usage: ./script/release_specification.sh <validate|build|compiled-host|extensions|profile|identity|historical-validate|historical-build|historical-extensions|historical-profile|historical-identity> [release-lock.json]" >&2

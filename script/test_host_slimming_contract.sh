...
jq -e '
  ...
  .build.built_in_extensions.first_party == [
    {
      name: "dbcode-wrapper-bson-viewer",
      source: "host/extensions/dbcode-wrapper-bson-viewer",
      reason: "The local viewer presents explicitly opened MongoDB Extended JSON with readable values and separate BSON types without reading DBCode internals or connecting to a database."
    },
    {

...
- 2026-07-27: Ticket 31 added prompt-free execution for one exact validated expired path. Dry-run planning remains the default, and class-wide cleanup, protected evidence, private profiles, unknown paths, broad paths, unreadable paths, and symbolic links remain refused.
